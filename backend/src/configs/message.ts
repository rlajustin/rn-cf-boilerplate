...
export enum RequestError {
  ...
  SmsVerificationLocked = "Too many SMS verification attempts. Please try again after 30 minutes.",
  EmailVerificationLocked = "Too many Email verification attempts. Please try again after 30 minutes.",
  ...
  InvalidDeviceInfo = "Device ID and type are required for device authentication",
  InvalidDeviceType = "Device type must be ios",
}
